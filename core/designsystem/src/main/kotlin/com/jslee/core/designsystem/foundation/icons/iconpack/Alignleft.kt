...
public val MooBesideIconPack.Alignleft: ImageVector
    get() {
        if (_alignleft != null) {
            return _alignleft!!
        }
        _alignleft = Builder(name = "Alignleft", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(4.5f, 8.934f)
                curveTo(4.003f, 8.934f, 3.6f, 9.337f, 3.6f, 9.834f)
                curveTo(3.6f, 10.331f, 4.003f, 10.734f, 4.5f, 10.734f)
                horizontalLineTo(14.5f)
                curveTo(14.997f, 10.734f, 15.4f, 10.331f, 15.4f, 9.834f)
                curveTo(15.4f, 9.337f, 14.997f, 8.934f, 14.5f, 8.934f)
                horizontalLineTo(4.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(4.5f, 17.601f)
                curveTo(4.003f, 17.601f, 3.6f, 18.003f, 3.6f, 18.5f)
                curveTo(3.6f, 18.998f, 4.003f, 19.4f, 4.5f, 19.4f)
                horizontalLineTo(14.5f)
                curveTo(14.997f, 19.4f, 15.4f, 18.998f, 15.4f, 18.5f)
                curveTo(15.4f, 18.003f, 14.997f, 17.601f, 14.5f, 17.601f)
                horizontalLineTo(4.5f)
                close()
            }
        }
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Alignleft, contentDescription = "")
    }
}
