...
public val MooBesideIconPack.Squareplus: ImageVector
    get() {
        if (_squareplus != null) {
            return _squareplus!!
        }
        _squareplus = Builder(name = "Squareplus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.214f, 18.804f, 21.311f, 18.302f, 21.357f, 17.746f)
                curveTo(21.4f, 17.209f, 21.4f, 16.548f, 21.4f, 15.74f)
                verticalLineTo(8.264f)
                curveTo(21.4f, 7.456f, 21.4f, 6.795f, 21.357f, 6.258f)
                ...
                curveTo(18.849f, 4.832f, 19.17f, 5.154f, 19.372f, 5.549f)
                curveTo(19.459f, 5.722f, 19.526f, 5.96f, 19.563f, 6.405f)
                curveTo(19.6f, 6.86f, 19.6f, 7.447f, 19.6f, 8.302f)
                verticalLineTo(15.702f)
                curveTo(19.6f, 16.557f, 19.6f, 17.144f, 19.563f, 17.599f)
                curveTo(19.526f, 18.044f, 19.459f, 18.283f, 19.372f, 18.455f)
                ...
                curveTo(4.541f, 18.283f, 4.475f, 18.044f, 4.438f, 17.599f)
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Squareplus, contentDescription = "")
    }
}
