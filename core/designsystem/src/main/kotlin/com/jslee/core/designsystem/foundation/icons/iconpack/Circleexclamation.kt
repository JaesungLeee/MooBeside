...
public val MooBesideIconPack.Circleexclamation: ImageVector
    get() {
        ...
        _circleexclamation = Builder(name = "Circleexclamation", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.1f, 12.997f, 11.503f, 13.4f, 12.0f, 13.4f)
                curveTo(12.497f, 13.4f, 12.9f, 12.997f, 12.9f, 12.5f)
                verticalLineTo(8.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Circleexclamation, contentDescription = "")
    }
}
