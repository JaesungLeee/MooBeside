...
public val MooBesideIconPack.Triangleexclamation: ImageVector
    get() {
        ...
        _triangleexclamation = Builder(name = "Triangleexclamation", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 8.1f)
                curveTo(12.497f, 8.1f, 12.9f, 8.503f, 12.9f, 9.0f)
                verticalLineTo(13.0f)
                curveTo(12.9f, 13.497f, 12.497f, 13.9f, 12.0f, 13.9f)
                curveTo(11.503f, 13.9f, 11.1f, 13.497f, 11.1f, 13.0f)
                verticalLineTo(9.0f)
                curveTo(11.1f, 8.503f, 11.503f, 8.1f, 12.0f, 8.1f)
                close()
            }
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(13.0f, 16.5f)
                curveTo(13.0f, 17.052f, 12.552f, 17.5f, 12.0f, 17.5f)
                curveTo(11.448f, 17.5f, 11.0f, 17.052f, 11.0f, 16.5f)
                curveTo(11.0f, 15.947f, 11.448f, 15.5f, 12.0f, 15.5f)
                curveTo(12.552f, 15.5f, 13.0f, 15.947f, 13.0f, 16.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                close()
                moveTo(11.047f, 5.2f)
                curveTo(11.471f, 4.466f, 12.529f, 4.466f, 12.953f, 5.2f)
                lineTo(20.097f, 17.575f)
                curveTo(20.521f, 18.308f, 19.991f, 19.225f, 19.145f, 19.225f)
                horizontalLineTo(4.855f)
                curveTo(4.008f, 19.225f, 3.479f, 18.308f, 3.903f, 17.575f)
                lineTo(11.047f, 5.2f)
                close()
            }
        }
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Triangleexclamation, contentDescription = "")
    }
}
