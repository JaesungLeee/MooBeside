...
public val MooBesideIconPack.Alignjustify: ImageVector
    get() {
        ...
        _alignjustify = Builder(name = "Alignjustify", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(4.5f, 17.601f)
                curveTo(4.003f, 17.601f, 3.6f, 18.003f, 3.6f, 18.501f)
                curveTo(3.6f, 18.998f, 4.003f, 19.401f, 4.5f, 19.401f)
                horizontalLineTo(19.5f)
                curveTo(19.997f, 19.401f, 20.4f, 18.998f, 20.4f, 18.501f)
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Alignjustify, contentDescription = "")
    }
}
