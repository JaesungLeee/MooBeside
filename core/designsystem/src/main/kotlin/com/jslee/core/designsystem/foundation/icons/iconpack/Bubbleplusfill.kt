...
public val MooBesideIconPack.Bubbleplusfill: ImageVector
    get() {
        ...
        _bubbleplusfill = Builder(name = "Bubbleplusfill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(19.867f, 21.497f, 19.481f, 21.46f, 19.176f, 21.407f)
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Bubbleplusfill, contentDescription = "")
    }
}
