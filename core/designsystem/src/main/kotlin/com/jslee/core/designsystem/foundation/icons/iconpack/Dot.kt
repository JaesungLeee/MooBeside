...
public val MooBesideIconPack.Dot: ImageVector
    get() {
        if (_dot != null) {
            return _dot!!
        }
        _dot = Builder(name = "Dot", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF171719)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(18.0f, 12.0f)
                curveTo(18.0f, 15.312f, 15.312f, 18.0f, 12.0f, 18.0f)
                curveTo(8.688f, 18.0f, 6.0f, 15.312f, 6.0f, 12.0f)
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MooBesideIconPack.Dot, contentDescription = "")
    }
}
